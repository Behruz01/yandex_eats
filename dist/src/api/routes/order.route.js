...
exports.router.post("/order", order_controller_1.postOrder);
exports.router.get("/order", order_controller_1.getOrder);
exports.router.get("/order/delivering", order_controller_1.getDelivering);
...
exports.router.delete("/order/:id", isAdmin_middleware_1.isAdmin, order_controller_1.deleteOrder);
exports.router.put("/order/:id", order_controller_1.updatedOrder);
exports.router.get("/order/:id", order_controller_1.getOneOrder);
